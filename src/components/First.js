...
export default function First(props) {
  return (
      ...
      <div className="flex gap-10 justify-center items-center h-[90vh]">
       <img width={200} src="anydo.png" alt="logo"/>
       ...
       <Link to="/todos"><button  className="mx-3 shadow-lg shadow-gray-500 bg-slate-900 px-2 py-1 rounded-lg text-sm text-red-600 cursor-pointer hover:text-lg transition-all w-40 h-10">Get started</button></Link>
       </div>
      </div>
     </>
  )
